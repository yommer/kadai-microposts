...
ActiveRecord::Schema.define(version: 20180812095946) do
  ...
  create_table "favourites", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.index ["user_id", "micropost_id"], name: "index_favourites_on_user_id_and_micropost_id", unique: true, using: :btree
  ...
  add_foreign_key "favourites", "users", column: "micropost_id"
